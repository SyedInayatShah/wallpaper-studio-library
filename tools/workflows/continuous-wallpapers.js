...
5. git add -A && git commit -m "Add wallpapers: <slugs>" && git push
6. Purge the CDN cache: curl -s https://purge.jsdelivr.net/gh/SyedInayatShah/wallpaper-studio-library@main/catalog.json >/dev/null
